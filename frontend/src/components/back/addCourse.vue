...
<p v-if="preview" class="formitem">所有图片的起讫时间均已被设置,去预览课程！<Button id="go" @click='Preview()'><Icon type="ios-arrow-dropright-circle" id="arrow"/></Button></p>
</div>
...
<div v-if="rest">
  ...
  <p class="formitem"><Button @click="Submit()">提交</Button></p>
</div>
