# Generated by Django 2.1 on 2018-08-22 16:17
    ...
    operations = [
            ...
            fields=[
                ...
                ('whole_introduction',
                 models.FileField(
                     ...
                     verbose_name='详解')),
                ('Is_distory',
                 models.BooleanField(default=False, verbose_name='是否阅后即焚')),
                ('distory_time',
                 models.DurationField(
                     blank=True, null=True, verbose_name='可阅时长')),
                ('Is_free', models.BooleanField(
                    default=True, verbose_name='免费')),
                ('price',
                 models.FloatField(
                     blank=True, default=0.0, null=True, verbose_name='价格')),
                ('sale_count',
                 models.PositiveIntegerField(
                     blank=True, default=0, null=True, verbose_name='销量')),
                ('view_count',
                 models.PositiveIntegerField(default=0, verbose_name='观看量')),
                ('share_rate',
                 models.FloatField(blank=True, null=True,
                                   verbose_name='分销比例')),
                ('can_comment',
                 models.BooleanField(default=True, verbose_name='允许用户留言')),
            ],
        ),
        migrations.CreateModel(
            name='Course_picture',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_type',
                 models.CharField(max_length=50, verbose_name='操作对象')),
                ('created_at',
                 models.DateTimeField(default=django.utils.timezone.now)),
                ('manager_username',
                 models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    max_length=10, verbose_name='订单状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time',
                 models.DateTimeField(
                     auto_now_add=True, verbose_name='开始学习时间')),
                ('last_study_percent',
                 models.DurationField(default=0, verbose_name='上次学习进度条')),
                ('course_id',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.CASCADE,
                     to='project_lab.Course')),
